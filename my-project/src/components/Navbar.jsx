    ...
    <div className="bg-gray-900 z-50  w-full py-3 fixed top-0">
      <div className="flex items-center justify-between max-w-7xl mx-auto px-4 md:px-0">
        ...
        <div>
          ...
          <Link to="/">
            <h1 className="font-bold text-3xl text-gray-300 flex items-center gap-2">
          ...
          <ul className="flex gap-7 text-xl items-center  font-semibold text-white">
            ...
            {!user ? (
              <div className="flex gap-3">
                <Link to="/login">
                  {" "}
                  <Button className="px-3 py-1 cursor-pointer rounded-md bg-blue-500 hover:bg-blue-600 text-white flex items-center gap-1">
                    Login
                  </Button>
                </Link>
                <Link to="/signup">
                  {" "}
                  <Button className="px-3 py-1 cursor-pointer rounded-md bg-gray-700 hover:bg-gray-800 text-white flex items-center gap-1">
                    Signup
                  </Button>
                </Link>
              </div>
              ...
              <div className="flex items-center gap-7">
                ...
                <Link>
                  ...
                  <Button
                    ...
                    className="px-3 py-1 cursor-pointer rounded-md bg-blue-500 hover:bg-blue-600 text-white flex items-center gap-1"
                  >
                    Logout
                  </Button>
                </Link>
